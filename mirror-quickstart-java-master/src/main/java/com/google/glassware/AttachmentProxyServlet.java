...
public class AttachmentProxyServlet extends HttpServlet {
  private static final GridLogger LOG = GridLogger.getLogger(AttachmentProxyServlet.class.getSimpleName());
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    if (attachmentId == null || timelineItemId == null) {
      LOG.warn("attempted to load image attachment with missing IDs");
      resp.sendError(400);
    }
