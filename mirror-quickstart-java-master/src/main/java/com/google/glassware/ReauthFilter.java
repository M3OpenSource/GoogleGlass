...
public class ReauthFilter implements Filter {
  private static final GridLogger LOG = GridLogger.getLogger(ReauthFilter.class.getSimpleName());
    ...
    if (response instanceof HttpServletResponse && request instanceof HttpServletRequest) {
      ...
      try {
        ...
        if (e.getDetails().getError().contains("invalid_grant")) {
          LOG.warn("User disabled Glassware. Attempting to re-authenticate");
