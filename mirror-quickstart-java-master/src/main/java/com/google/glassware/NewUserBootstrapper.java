...
public class NewUserBootstrapper {
  private static final GridLogger LOG = GridLogger.getLogger(NewUserBootstrapper.class.getSimpleName());
  ...
  public static void bootstrapNewUser(HttpServletRequest req, String userId) throws IOException {
    ...
    try {
      ...
      Subscription subscription =
          MirrorClient.insertSubscription(credential, WebUtil.buildUrl(req, "/notify").replace("your.company.net", "11.22.33.44"), userId,
              "timeline");
