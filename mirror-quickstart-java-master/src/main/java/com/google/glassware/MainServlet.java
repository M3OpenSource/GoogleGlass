...
public class MainServlet extends HttpServlet {
  ...
  private static final GridLogger LOG = GridLogger.getLogger(MainServlet.class.getSimpleName());
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
    ...
    if (req.getParameter("operation").equals("insertSubscription")) {
      ...
      try {
        ...
        LOG.warn("Could not subscribe " + WebUtil.buildUrl(req, "/notify") + " because "
      ...
      if (req.getParameter("iconUrl") == null || req.getParameter("name") == null) {
        ...
        // Insert a contact
        LOG.info("Inserting contact Item");
      ...
      // Insert a contact
      LOG.info("Deleting contact Item");
      ...
      LOG.info("Deleting Timeline Item");
      ...
      LOG.warn("Unknown operation specified " + operation);
